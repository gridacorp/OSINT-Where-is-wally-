DataHound Source-Available No Comercial  License v1.0
...
11. TELEMETRÍA Y PRIVACIDAD
    ...
    d) Consentimiento: Al ejecutar el software, consientes la telemetría. Puedes revocar el consentimiento desconectando Internet o eliminando %LOCALAPPDATA%\DataHound\uid.dat.
...
11. TELEMETRY AND PRIVACY
    ...
    d) Consent: By running the Software, you consent to telemetry. You may revoke consent by disconnecting from the Internet or deleting %LOCALAPPDATA%\DataHound\uid.dat.
